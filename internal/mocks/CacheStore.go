...
func (_m *CacheStore) Delete(key string) error {
	ret := _m.Called(key)
...
func (_m *CacheStore) Exists(key string) (bool, error) {
	ret := _m.Called(key)
...
func (_m *CacheStore) Get(key string) (string, error) {
	ret := _m.Called(key)
...
func (_m *CacheStore) Set(key string, value interface{}, expiration time.Duration) error {
